...
unsigned int  BindHttpActionHandler::ParseThingsURI(std::string RxURI,std::string* ArrayOfURI)
{
...
void BindHttpActionHandler::handleRequest(HTTPServerRequest &req, HTTPServerResponse &resp)
{
