...
unsigned int  BindHttpPropertyHandler::ParseThingsURI(std::string RxURI,std::string* ArrayOfURI)
{
...
void BindHttpPropertyHandler::handleRequest(HTTPServerRequest &req, HTTPServerResponse &resp)
{
    ...
    else
    {
        ...
        if (RequestMethod == "GET")
        {
            ...
            // out << Response.get("value").toString();
        }
        else
        {
